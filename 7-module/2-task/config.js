module.exports = {
  ...
  providers: {
    ...
    vkontakte: {
      app_id: process.env.VKONTAKTE_APP_ID || 7178743,
      app_secret: process.env.VKONTAKTE_APP_SECRET || 'on4CczGfZ4bF6uqe2Som',
      callback_uri: 'http://localhost:3000/api/oauth/vkontakte/callback',
      options: {
        scope: ['email'],
      },
    },
