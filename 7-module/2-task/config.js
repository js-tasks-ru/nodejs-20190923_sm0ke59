module.exports = {
  ...
  providers: {
    github: {
      app_id: process.env.GITHUB_APP_ID || 'facebook_app_id',
      app_secret: process.env.GITHUB_APP_SECRET || 'facebook_app_secret',
    ...
    vkontakte: {
      app_id: process.env.VKONTAKTE_APP_ID || 'facebook_app_id',
      app_secret: process.env.VKONTAKTE_APP_SECRET || 'facebook_app_secret',
